...
<html lang="en">
  ...
  $fclass = !empty($_GET['Fclass']) ? $_GET['Fclass']: null;
  if($fclass == "hhboy"){
    echo $fclass;
    header("location:./pages/backEnd");
  }else{
...
?>
  <body class="goto-here">
    ...
    <div class="hero-wrap hero-bread" style="background-image: url('images/spi.png');">
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="./index.php">Home</a></span></p>
            <h1 class="mb-0 bread">主廚一覽</h1>
          </div>
        </div>
      </div>
    </div>
    	...
    	<div class="container">
    		<div class="row justify-content-center">
    			<div class="col-md-10 mb-5 text-center">
    				<ul class="product-category" id="menu">
    				</ul>
    			</div>
    		</div>
    		<div class="row" id="cheflist">
	...
	LoadFood("cheflist", '<?php echo $fclass; ?>', <?php echo @$_GET["Pages"]; ?>);
