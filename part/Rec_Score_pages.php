    ...
    <div class="col text-center">
        <div class="block-27">
            <ul>
                <?php
                if($Pages != 1){
                    echo '<li><a href="./Recommended_Score.php?Fclass=' . $_GET['Fclass'] . '&item=2&Pages=' . ($Pages - 1) . '">&lt;</a></li>';
                }
                $con = 0;
                for($i = 1; $i <= $pages_count; $i++ ){
                    
                    if($Pages == $i){
                        echo '<li class="active"><a href="./Recommended_Score.php?Fclass=' . $_GET['Fclass'] . '&item=2&Pages=' . $i. '">' . $i . '</a></li>';
                    }else if($i > $Pages){
                        echo '<li><a href="./Recommended_Score.php?Fclass=' . $_GET['Fclass'] . '&item=2&Pages=' . $i. '">' . $i . '</a></li>';
                        $con ++;
